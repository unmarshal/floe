...
(define Floe-findCol (lambda (arg-1 arg-2) (if (null? arg-1) '() (let ((e-3 (car arg-1))) (let ((e-4 (cdr arg-1))) (let ((e-5 (vector-ref e-3 0))) (let ((e-7 (vector-ref e-3 2))) (cond ((equal? e-7 0) (let ((sc2 (PreludeC-45EqOrd-u--C-61C-61_Eq_String e-5 arg-2))) (cond ((equal? sc2 1) (box 0)) (else (PreludeC-45Types-u--map_Functor_Maybe (lambda (eta-0) (+ eta-0 1)) (Floe-findCol e-4 arg-2)))))) (else (PreludeC-45Types-u--map_Functor_Maybe (lambda (eta-0) (+ eta-0 1)) (Floe-findCol e-4 arg-2)))))))))))
(define Floe-renameAt (lambda (arg-1 arg-2 arg-3) (cond ((equal? arg-1 0) (let ((e-5 (car arg-3))) (let ((e-6 (cdr arg-3))) (let ((e-8 (vector-ref e-5 1))) (let ((e-9 (vector-ref e-5 2))) (cons (vector arg-2 e-8 e-9) e-6))))))(else (let ((e-2 (- arg-1 1))) (let ((e-12 (car arg-3))) (let ((e-13 (cdr arg-3))) (cons e-12 (Floe-renameAt e-2 arg-2 e-13)))))))))
...
(define Floe-rename (lambda (arg-1 arg-2 ext-0) (let ((e-1 (car ext-0))) (let ((e-2 (cdr ext-0))) (let ((sc1 (Floe-findCol e-1 arg-1))) (if (null? sc1) (vector 0 (string-append "Column not found: " arg-1)) (let ((e-3 (unbox sc1))) (let ((u--sC-39 (Floe-renameAt e-3 arg-2 e-1))) (vector 1 'erased (cons u--sC-39 (PreludeC-45TypesC-45List-tailRecAppend e-2 (cons (vector 0 arg-1 arg-2) '()))))))))))))
(define csegen-3 (lambda (eta-0) (Floe-rename "id" "user_id" eta-0)))
...
(define Floe-mkCol (lambda (arg-0 arg-1) (vector arg-0 arg-1 0)))
(define Floe-deleteAt (lambda (arg-1 arg-2) (cond ((equal? arg-1 0) (let ((e-5 (car arg-2))) (let ((e-6 (cdr arg-2))) (let ((e-7 (vector-ref e-5 0))) (let ((e-8 (vector-ref e-5 1))) (cons (vector e-7 e-8 1) e-6))))))(else (let ((e-2 (- arg-1 1))) (let ((e-12 (car arg-2))) (let ((e-13 (cdr arg-2))) (cons e-12 (Floe-deleteAt e-2 e-13)))))))))
(define Floe-u--C-62C-62C-61_Monad_C-40BuilderC-32C-36nC-41 (lambda (arg-3 arg-4 ext-0) (let ((sc0 (arg-3 ext-0))) (case (vector-ref sc0 0) ((0) (let ((e-2 (vector-ref sc0 1))) (vector 0 e-2))) (else (let ((e-5 (vector-ref sc0 1))) (let ((e-6 (vector-ref sc0 2))) ((arg-4 e-5) e-6))))))))
(define Floe-from (lambda (arg-1) (cons arg-1 '())))
(define Floe-drop (lambda (arg-1 ext-0) (let ((e-1 (car ext-0))) (let ((e-2 (cdr ext-0))) (let ((sc1 (Floe-findCol e-1 arg-1))) (if (null? sc1) (vector 0 (string-append "Column not found: " arg-1)) (let ((e-3 (unbox sc1))) (let ((u--sC-39 (Floe-deleteAt e-3 e-1))) (vector 1 'erased (cons u--sC-39 (PreludeC-45TypesC-45List-tailRecAppend e-2 (cons (vector 1 arg-1) '()))))))))))))
(define Floe-toPolars (lambda (arg-0 arg-1) (if (null? arg-0) arg-1 (let ((e-2 (car arg-0))) (let ((e-3 (cdr arg-0))) (case (vector-ref e-2 0) ((0) (let ((e-4 (vector-ref e-2 1))) (let ((e-5 (vector-ref e-2 2))) (Floe-toPolars e-3 (string-append arg-1 (string-append ".rename({\"" (string-append e-4 (string-append "\": \"" (string-append e-5 "\"})"))))))))) (else (let ((e-6 (vector-ref e-2 1))) (Floe-toPolars e-3 (string-append arg-1 (string-append ".drop(\"" (string-append e-6 "\")"))))))))))))
(define Floe-generate (lambda (arg-2) (case (vector-ref arg-2 0) ((0) (let ((e-2 (vector-ref arg-2 1))) (vector 0 e-2))) (else (let ((e-6 (vector-ref arg-2 2))) (let ((e-9 (cdr e-6))) (vector 1 (Floe-toPolars e-9 "df"))))))))
(define Floe-MySchema (cons (Floe-mkCol "id" 1) (cons (Floe-mkCol "name" 0) (cons (Floe-mkCol "active" 2) '()))))
(define Floe-example1 (lambda (ext-0) (Floe-u--C-62C-62C-61_Monad_C-40BuilderC-32C-36nC-41 csegen-3 (lambda (_-10685) (lambda (eta-0) (Floe-u--C-62C-62C-61_Monad_C-40BuilderC-32C-36nC-41 (lambda (eta-1) (Floe-rename "name" "username" eta-1)) (lambda (_-10686) (lambda (eta-1) (Floe-drop "active" eta-1))) eta-0))) ext-0)))
(define Floe-example2 (lambda (ext-0) (Floe-u--C-62C-62C-61_Monad_C-40BuilderC-32C-36nC-41 csegen-3 (lambda (_-10685) (lambda (eta-0) (Floe-rename "missing" "whatever" eta-0))) ext-0)))
(define Floe-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "=== Floe eDSL ===\xa;\xa;" ext-0))) (let ((act-2 (PreludeC-45IO-prim__putStr "Example 1 (valid pipeline):\xa;" ext-0))) (let ((act-3 (let ((sc0 (Floe-generate (Floe-example1 (Floe-from Floe-MySchema))))) (case (vector-ref sc0 0) ((0) (let ((e-2 (vector-ref sc0 1))) (PreludeC-45IO-prim__putStr (string-append (string-append "  ERROR: " e-2) "\xa;") ext-0))) (else (let ((e-5 (vector-ref sc0 1))) (PreludeC-45IO-prim__putStr (string-append (string-append "  " e-5) "\xa;") ext-0))))))) (let ((act-4 (PreludeC-45IO-prim__putStr "\xa;Example 2 (error case):\xa;" ext-0))) (let ((act-5 (let ((sc0 (Floe-generate (Floe-example2 (Floe-from Floe-MySchema))))) (case (vector-ref sc0 0) ((0) (let ((e-2 (vector-ref sc0 1))) (PreludeC-45IO-prim__putStr (string-append (string-append "  ERROR: " e-2) "\xa;") ext-0))) (else (let ((e-5 (vector-ref sc0 1))) (PreludeC-45IO-prim__putStr (string-append (string-append "  " e-5) "\xa;") ext-0))))))) (PreludeC-45IO-prim__putStr "\xa;=== Done ===\xa;" ext-0))))))))
           ...
           (collect
            ...
            (let loop ([c this-counter] [gen 0])
              (cond
                ...
                [else
                 gen]))))]))))
(PrimIO-unsafePerformIO (lambda (eta-0) (Floe-main eta-0)))
